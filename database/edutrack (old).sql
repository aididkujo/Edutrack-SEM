...
INSERT INTO `attendance` (`attendanceID`, `slotID`, `sessionDate`, `status`, `remarks`, `checkedInAt`, `courseID`, `userID`) VALUES
(8, 1, '2025-12-19', 'Present', NULL, '2025-12-19 22:24:56', 1, 7);
...
INSERT INTO `attendance_slot` (`slotID`, `courseID`, `slotDate`, `slotTime`, `code`, `createdBy`, `createdAt`, `updatedAt`) VALUES
(1, 1, '2025-12-19', '22:00:00', '12345', 4, '2025-12-19 14:24:18', '2025-12-19 14:24:18');
...
CREATE TABLE `evaluation` (
  ...
  CONSTRAINT `chk_q1` CHECK (`q1_rating` BETWEEN 1 AND 5),
  CONSTRAINT `chk_q2` CHECK (`q2_rating` BETWEEN 1 AND 5),
  CONSTRAINT `chk_q3` CHECK (`q3_rating` BETWEEN 1 AND 5),
  CONSTRAINT `chk_q4` CHECK (`q4_rating` BETWEEN 1 AND 5),
  CONSTRAINT `chk_q5` CHECK (`q5_rating` BETWEEN 1 AND 5)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(4, 'Ts. Dr. Hoh Wei Siang', 'bcn1053.lecturer@edutrack.local', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'lecturer', 'active', NULL, '2025-12-14 15:14:40', '2025-12-14 15:14:40', '2025-12-19 13:41:42', '2025-12-19 13:41:42', NULL, 0),
...
(7, 'Umie Kalsum Ghazali', 'cb22045@student.edutrack.local', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'student', 'active', NULL, '2025-12-14 15:15:44', '2025-12-14 15:15:44', '2025-12-19 14:24:35', '2025-12-19 14:24:35', NULL, 0),
...
ALTER TABLE `evaluation`
  ...
  ADD INDEX `idx_eval_evaluator` (`evaluatorID`),
  ADD INDEX `idx_eval_evaluatee` (`evaluateeID`),
  ADD INDEX `idx_eval_course` (`courseID`),
  ADD INDEX `idx_eval_type` (`evaluationType`),
  ADD INDEX `idx_eval_created` (`createdAt`),
...
--
ALTER TABLE `attendance`
  MODIFY `attendanceID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `attendance_slot`
--
ALTER TABLE `attendance_slot`
  MODIFY `slotID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `notes`
  MODIFY `noteID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `password_resets`
--
ALTER TABLE `password_resets`
  MODIFY `passwordresetsID` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `progress_summary`
--
ALTER TABLE `progress_summary`
  MODIFY `summaryID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `quiz_answer`
--
ALTER TABLE `quiz_answer`
  MODIFY `answerID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `quiz_attempt`
--
ALTER TABLE `quiz_attempt`
  MODIFY `attemptID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `quiz_option`
--
ALTER TABLE `quiz_option`
  MODIFY `optionID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
